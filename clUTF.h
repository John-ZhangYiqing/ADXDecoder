...
public:
	...
	clElement *GetElement(unsigned int pageIndex);                   // ※If not found, a TYPE_NULL element is returned
	clElement *GetElement(unsigned int pageIndex,const char *name);  // ※If not found, a TYPE_NULL element is returned
